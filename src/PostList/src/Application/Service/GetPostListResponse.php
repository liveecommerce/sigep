...
use Live\Sigep\Sigep\Application\Service\AbstractDataResponse;

/**
 * Resposta do serviço de geração da lista de postagem
 *
 * @package Live\Sigep\PostList\Application\Service
 */
class GetPostListResponse extends AbstractDataResponse
{
}
